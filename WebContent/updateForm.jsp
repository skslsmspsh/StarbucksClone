...
<html>
  ...
  <body>
    ...
    <section>
		...
		%>
		<form name="writeform" action="updatePro.jsp" onsubmit="return writeSave()">
		<table >
		  <tr height="30s">
		    <td style="font-weight:bold;" id="updatetd" width="125" align="center" bgcolor=<%=value_c %>>이 름</td>
		    <td id="updatetd" align="left" width="330">
		       <input type="text" size="10" maxlength="10" name="writer" style="ime-mode:active;" value="<%=article.getWriter() %>">
			   <input type="hidden" name="num" value="<%=num %>">
			</td>
		  </tr>
		  <tr>
		    <td style="font-weight:bold;" id="updatetd" width="125" align="center" bgcolor=<%=value_c %>>제 목</td>
		    <td id="updatetd" align="left" width="330">
		       <input type="text" size="40" maxlength="50" name="subject" style="ime-mode:active;" value="<%=article.getSubject() %>">
		    </td>
		  </tr>
		  <tr>
		    <td style="font-weight:bold;" id="updatetd" width="125" align="center" bgcolor=<%=value_c %>>Email</td>
		    <td id="updatetd" align="left" width="330">
		       <input type="text" size="40" maxlength="30" name="email" style="ime-mode:inactive;" value="<%=article.getEmail() %>">
		    </td>
		  </tr>
		  <tr>
		    <td style="font-weight:bold;" id="updatetd" width="125" align="center" bgcolor=<%=value_c %>>내 용</td>
		    <td id="updatetd" align="left" width="330">
		     <textarea name="content" rows="45" cols="100%" style="ime-mode:active;"><%=article.getContent() %></textarea>
		    </td>
		  </tr>
		  <tr>
		    <td style="font-weight:bold;" id="updatetd" width="125" align="center" bgcolor=<%=value_c %>>비밀번호</td>
		    <td id="updatetd" align="left" width="330" >
		     <input type="password" size="8" maxlength="12" 
		               name="passwd" style="ime-mode:inactive;"><%=article.getPasswd() %>
			 </td>
		  </tr>
		  <tr>      
		   <td colspan=2 align="center"> 
		     <input id="Allbutton" style="cursor:pointer" type="submit" value="글수정">  
		     <input id="Allbutton" style="cursor:pointer" type="reset" value="다시작성">
		     <input id="Allbutton" style="cursor:pointer" type="button" value="목록보기" onClick="document.location.href='list.jsp'">
		   </td>
		 </tr>
		 </table>
		</form>
